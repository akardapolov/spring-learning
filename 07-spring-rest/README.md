...
- **OpenAPI JSON**: `http://localhost:8891/v3/api-docs`

Ссылка на Swagger UI также доступна на главной странице `http://localhost:8891/`

### Возможности Swagger UI

- Просмотр всех эндпоинтов API с описаниями
- Интерактивное тестирование запросов прямо из браузера
- Просмотр моделей запросов/ответов с примерами
- Информация о параметрах, статус-кодах и форматах данных

### Аннотации Swagger

В коде использованы аннотации OpenAPI для улучшения документации:
- `@Tag` - группировка контроллеров
...
- `http://localhost:8891/` — главная страница с документацией
- `http://localhost:8891/index.html` — прямая ссылка на документацию
